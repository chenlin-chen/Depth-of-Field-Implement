...
from scatter_blur import ScatterBlurOptim, ScatterBlurWithDepth
...
def main():
    ...
    focal_depth = 128
    focal_len = int( 25.0 / (1.0 + (focal_depth/128.0)**2 ) )
    blured_img = ScatterBlurWithDepth(sub_img, sub_depth_map_int, focal_depth, focal_len, sub_blur_r)
